...
- Filters: [{'field': 'keywords', 'string_list': ['neurocysticercosis']}, {'field': 'case_strings', 'string_list': ['neurocysticercosis'], 'operator': 'all'}, {'field': 'label', 'string_list': ['chart'], 'operator': 'none'}]
