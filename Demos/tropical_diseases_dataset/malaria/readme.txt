...
- Name: malaria
- Type: multimodal
- Date: 2026-09-26 09:41
- Filters: [{'field': 'keywords', 'string_list': ['malaria']}, {'field': 'case_strings', 'string_list': ['malaria'], 'operator': 'all'}, {'field': 'label', 'string_list': ['chart'], 'operator': 'none'}]
