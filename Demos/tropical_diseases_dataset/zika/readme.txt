...
- Name: zika
- Type: multimodal
- Date: 2026-09-26 11:47
- Filters: [{'field': 'keywords', 'string_list': ['zika'], 'match_type': 'partial_match'}, {'field': 'case_strings', 'string_list': ['zika'], 'operator': 'all'}, {'field': 'label', 'string_list': ['chart'], 'operator': 'none'}]
- MultiCaRe version ID: 20416562
