...
- Filters: [{'field': 'keywords', 'string_list': ['leptospirosis']}, {'field': 'case_strings', 'string_list': ['leptospirosis'], 'operator': 'all'}, {'field': 'label', 'string_list': ['chart'], 'operator': 'none'}]
